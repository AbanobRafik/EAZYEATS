...
const NavBar = () => {
  ...
  return (
    <div className="fixed top-0 w-full z-50">
      <nav className="relative flex-wrap flex w-full justify-between items-center px-12 py-4 backdrop:blur-md border-b-amber-300 border-b-2 bg-white/10 backdrop-blur-md border shadow-lg">
        {/* for small screen */}
